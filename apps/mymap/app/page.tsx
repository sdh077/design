...
const sectorSlides = [
  ...
  },
  {
    id: 5,
    type: "life-impact",
    title: "단계별 구체 종목·ETF & 진입 전략",
    columns: [
      {
        icon: "🔴",
        label: "1단계 — 조정 시 분할 매수",
        title: "반도체·전력 인프라",
        points: [
          "🇺🇸 NVDA · AMD · AVGO",
          "🇰🇷 SK하이닉스 · 한미반도체",
          "⚡ ETF: SOXX, SMH",
          "🔌 두산에너빌리티 · 이수페타시스",
          "전략: 추격 매수 ✗, 5~10% 조정 시 분할 ✓",
        ],
        color: "orange",
      },
      {
        icon: "🟡",
        label: "2단계 — 지금 신규 진입 적기",
        title: "사이버보안·클라우드·SaaS",
        points: [
          "🔐 CRWD · PANW · ZS",
          "☁️ MSFT · AMZN · GOOG",
          "📊 CRM · NOW · SNOW",
          "⚖️ ETF: BUG, WCLD",
          "전략: 1단계보다 밸류 부담 낮음 → 비중 확대",
        ],
        color: "blue",
      },
      {
